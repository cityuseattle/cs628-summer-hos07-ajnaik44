...
db.users.insertMany([  { name: 'user1', age: 30, email: 'user1@example.com' },  { name: 'user2', age: 25, email: 'user2@example.com' },  { name: 'user3', age: 28, email: 'user3@example.com' }])
db.users.find()
...
db.places.insertMany([  { name: 'Park A', location: { type: 'Point', coordinates: [0, 0] } },
